...
class WilayaDropDawnButton extends StatelessWidget {
  WilayaDropDawnButton({super.key});
        ...
        children: [
          ...
          DropdownButtonHideUnderline(
            child: DropdownButton2<Wilaya>(
              ...
              items: staticsController.wilayaList.wilayaList
                  .map(
                    (item) => DropdownMenuItem(
                      value: item,
                      child: Text(
                        "${item.code} - ${item.arName}",
                  ...
                  .toList(),
              value: staticsController.selectedWilaya,
              onChanged: (value) =>
                  staticsController.changeSelctedWilaya(value!),
