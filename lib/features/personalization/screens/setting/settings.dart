...
import 'package:cwt_ecommerce_ui_kit/features/personalization/screens/setting/widgets/settings_menu.dart';
...
import '../../../authentication/screens/chose_type/chose_screen.dart';
...
class SettingsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: !userController.isSignedIn
          ? Center(
              child: SizedBox(
                width: Get.width * 0.9,
